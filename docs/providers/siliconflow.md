...
Chinese AI infra platform (siliconflow.cn / siliconflow.com) offering model APIs; candidate provider, no verified free offer recorded.
...
- API base: `https://api.siliconflow.com/v1`
...
- [Official](https://siliconflow.com)
